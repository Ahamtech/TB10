...
void ApplicationUI::authNeeded()
{
    qDebug() << "Loading Auth view QML";
    QmlDocument *qml = QmlDocument::create("asset:///intro/welcome.qml").parent(this);
...
void ApplicationUI::mainview()
{
    ...
    qml->setContextProperty("app", this);
    QDeclarativePropertyMap *filepathname = new QDeclarativePropertyMap;
    filepathname->insert("photos", QVariant(QString("file://" + QDir::homePath())));
